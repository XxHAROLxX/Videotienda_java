...
public class InterfazVideotienda extends JFrame
{
    ...
    public void mostrarPelicula( String titulo )
    {
        ...
        if( p == null )
            JOptionPane.showMessageDialog( this, "La pelicula no existe", "Ver Información Pelicula", JOptionPane.ERROR_MESSAGE );
    ...
    public void mostrarCliente( String cedula )
    {
        ...
        if( c == null )
        {
            JOptionPane.showMessageDialog( this, "El cliente no esta registrado", "Ver Informaci�n Cliente", JOptionPane.ERROR_MESSAGE );
            return;
        }
    ...
    public void alquilarPelicula( )
    {
        ...
        try
        {
            ...
            JOptionPane.showMessageDialog( this, "Se alquilo la copia " + copia + " de la pelicula \"" + pelicula + "\"", "Alquilar Pelacula", JOptionPane.INFORMATION_MESSAGE );
        }
        catch( Exception e )
        {
